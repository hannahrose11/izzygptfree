...
export default function App() {
  ...
  const questions = [
    { id: "task", question: "What annoying task are you automating today?" },
    { id: "data", question: "What’s the input/source data?" },
    { id: "format", question: "What format should the final output be in?" },
    { id: "audience", question: "Who’s the audience and what do they care about?" },
    { id: "success", question: "What does a good result look like?" },
  ];
  ...
  return (
    <div style={{ fontFamily: "Manrope, sans-serif", maxWidth: 600, margin: "0 auto", padding: 24 }}>
      {!finalPrompt ? (
